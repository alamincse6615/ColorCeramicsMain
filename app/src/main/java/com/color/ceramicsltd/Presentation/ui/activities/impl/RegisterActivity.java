...
import com.color.ceramicsltd.Presentation.presenters.RegisterPresenter;
...
public class RegisterActivity extends BaseActivity implements RegisterView {
        ...
        btn_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid){
                    ...
                    jsonObject.addProperty("email_or_phone", input_email.getText().toString());
    ...
    public void setRegistrationResponse(RegistrationResponse registrationResponse) {
        otpAlert(registrationResponse.getMessage());
    }
    public void otpAlert(String serverOtp){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Verification code has been sent on your phone number..");
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Otp_input = input.getText().toString();
                if (Otp_input.equals(serverOtp)) {
                    Intent intent = new Intent(RegisterActivity.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                    CustomToast.showToast(RegisterActivity.this, "Registration Success", R.color.colorSuccess);
                }
            }
        });
